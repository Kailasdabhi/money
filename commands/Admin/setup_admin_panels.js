...
var panel = {
  ...
  description: "767803515",
  index: 0,
  icon: "Qwg6aXbA9s1yfwsf7m2zNlJczOOIDgr93C1ffGOo",
  ...
  fields: [
    {
      name: "Data_Manager",
      title: "Data_Manager",
      description: "for example: @Data_Manager. User must join to it on bots starting",
      type: "string",
      icon: "chatboxes"
    },
    {
      name: "CHANELL_URL",
      title: "Chanell url",
      description: "for example: https://t.me/Data_Manager. User must join to it on bots starting",
      type: "string",
      icon: "link"
    },
    {
